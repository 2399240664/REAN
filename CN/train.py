...
def train(args):
    ...
    # ent2id, rel2id, triples, train_loader, val_loader,test_loader = load_data(args.input_dir, args.bert_name, args.batch_size)
    ...
    scheduler = ReduceLROnPlateau(optimizer, mode='min',patience=2,verbose=True,factor=0.8)
...
def main():
    ...
    # model parameters
    parser.add_argument('--bert_name', default='bert-base-chinese', choices=['roberta-base', 'bert-base-uncased','bert-base-cased'])
